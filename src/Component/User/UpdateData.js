...
export default function UpdateData() {
    ...
    return (
        <div style={{ display: 'flex ', justifyContent: 'center', alignItems: 'center', background: 'transparent', height: '100vh' }}>
            <div style={{ opacity: 10, width: 500, padding: 8, lineHeight: 2, background: '5px blur' , boxShadow: "2px -10px 21px 2px  grey" ,borderRadius:10 }}>
               <Grid2 xs={12} style={{display:'flex',justifyContent:'space-between',alignItems:'center'}} >
                <Grid2 xs={6}>
                <div style={{fontSize:40,fontWeight:"bolder",fontFamily:"-moz-initial",textTransform:'underline',color:'#30336b'}}>Update Data</div>
